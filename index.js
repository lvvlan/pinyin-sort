...
// 3. 字母排序
const letterSort = (json) => Object.keys(json).length ? Object.keys(json).sort().map((item) => ({
    pinyin: item,
    value: json[item]
})) : {}
